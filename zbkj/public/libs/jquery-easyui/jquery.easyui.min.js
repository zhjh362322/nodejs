...
$(_46c.target).children("div.menu-icons").remove();
if(_46c.iconCls){
$("<div class=\"menu-icons\"></div>").addClass(_46c.iconCls).appendTo(_46c.target);
}
});
...
var _511=_510.find(".textbox-icons");
if(opts.height=="auto"){
...
if(icon.length){
var _523=parseInt(icon.attr("icons-index"));
...
_522.find(".textbox-icons").each(function(_524){
...
return jq.data("textbox").textbox.find(".textbox-icons:eq("+_53e+")");
...
var _980=cell.children("span.tree-icons");
...
_b72.find(".textbox-icons").css("height","100%");
