...
p.html("<span class=\"tree-dnd-icons tree-dnd-no\">&nbsp;</span>"+$(_16).find(".tree-title").html());
p.hide();
return p;
...
var _2a=$(_28).draggable("proxy").find("span.tree-dnd-icons");
...
var _6c=_6a.find("span.tree-icons");
...
if(_9f(_9b,_9d[0])){
var _a0=_9d.find("span.tree-icons");
...
var _ab=$(_aa.target);
_ab.find(".tree-icons").removeClass("tree-folder").addClass("tree-file");
...
if(_b2.iconCls){
_b1.find(".tree-icons").removeClass(_b2.iconCls);
}
$.extend(_b2,_af);
_b1.find(".tree-title").html(_b0.formatter.call(_ae,_b2));
if(_b2.iconCls){
_b1.find(".tree-icons").addClass(_b2.iconCls);
}
_4f(_ae,_af.target);
};
