...
var _1b=_1a.find(".textbox-icons");
if(_16.height=="auto"){
...
var _2f=$(e.target).closest("a.textbox-icons:not(.textbox-icons-disabled)");
if(_2f.length){
var _30=parseInt(_2f.attr("icons-index"));
...
_2e.find(".textbox-icons").each(function(_32){
var _33=_2b.icons[_32];
var _34=$(this);
if(!_33||_33.disabled||_2b.disabled||_2b.readonly){
_34.addClass("textbox-icons-disabled");
}else{
_34.removeClass("textbox-icons-disabled");
}
});
var btn=tb.find(".textbox-button");
...
return jq.data("textbox").textbox.find(".textbox-icons:eq("+_59+")");
