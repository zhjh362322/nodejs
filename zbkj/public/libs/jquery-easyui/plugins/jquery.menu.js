...
if(_15.iconCls){
$("<div class=\"menu-icons\"></div>").addClass(_15.iconCls).appendTo(_14);
}
if(_15.id){
_14.attr("id",_15.id);
}
...
$(_68.target).children("div.menu-icons").remove();
if(_68.iconCls){
$("<div class=\"menu-icons\"></div>").addClass(_68.iconCls).appendTo(_68.target);
}
});
